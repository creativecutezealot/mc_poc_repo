...
class _ChannelList extends State<ChannelList> {
  ...
  Widget build(BuildContext context) {
    ...
    print('widget channel_list: ');
    print(chatClient.state.currentUser);
            ...
            child: _isSearchActive
                    ...
                    child: MessageSearchListView(
                      ...
                      onItemTap: (messageResponse) async {
                        ...
                        Navigator.pushNamed(
                          context,
                          ChannelPage.id,
                          arguments: ChannelPageArgs(client, channel, message),
                        );
                      },
                    ),
                  )
                : ChannelsBloc(
                    child: ChannelListView(
                      ...
                      channelWidget: ChannelPage(chatClient: chatClient),
