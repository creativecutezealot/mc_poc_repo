...
class ChannelPageArgs {
  ...
  ChannelPageArgs(this.chatClient, this.channel, this.initialMessage);
}

class ChannelPage extends StatefulWidget {
  static const String id = 'new_channel';
...
class _ChannelPageState extends State<ChannelPage> {
  ...
  Widget build(BuildContext context) {
    print('chatClient status: ');
    print(widget.chatClient.state.currentUser);
    return StreamChat(
      client: widget.chatClient,
      child: widget.channel != null ? StreamChannel(
          ...
          appBar: ChannelHeader(
            ...
            onImageTap: () async {
              ...
              if (channel!.memberCount == 2 && channel.isDistinct) {
                final currentUser = widget.chatClient.state.currentUser;
  ...
  bool defaultFilter(Message m) {
    var _currentUser = widget.chatClient.state.currentUser;
